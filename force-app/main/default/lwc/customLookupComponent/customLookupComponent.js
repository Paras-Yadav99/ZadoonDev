...
export default class CustomLookupComponent extends LightningElement {
    ...
    handleSelect(event){
        ...
        if(this.hasOneField) {
        	this.selectedRecord = selectRecord.FIELD1;
        } else {
        	this.selectedRecord = selectRecord.FIELD1 +' - '+ selectRecord.FIELD2 + ' - ' + selectRecord.FIELD3;
        }
